                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($Tranfusi as $trf) : ?>
                                        <tr>
                                            ...
                                            <td><?= $trf['status']; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#entriPasienTranfusi"><i class="fas fa-solid fa-pen-to-square fa-beat-fade" style="--fa-beat-fade-opacity: 0.67; --fa-beat-fade-scale: 1.075;"></i> Entry</button>
...
<!-- Modal Entri -->
<div class="modal fade" id="entriPasienTranfusi" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="entriPasienTranfusiLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-gradient-secondary">
                <h5 class="modal-title text-white" id="entriPasienTranfusiLabel">Entri Pasien Tranfusi Darah</h5>
