<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="https://pkugamping.com/" target="_blank"> <img src="<?= base_url('assets/'); ?>img/pku.png" width="35px" style=" margin: 0 10px 7px 0;">RME Obgyn</a>
    <!-- Sidebar Toggle-->
