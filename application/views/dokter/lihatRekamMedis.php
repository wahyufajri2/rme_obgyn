                    ...
                    <tbody>
                        ...
                        <?php foreach ($Kebidanan as $kbd) : ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#dokterlihatRekamMedis_<?= $kbd['no_rg']; ?>">
...
<?php foreach ($Kebidanan as $kbd) : ?>
    <div class="modal fade" id="dokterlihatRekamMedis_<?= $kbd['no_rg']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="dokterlihatRekamMedisLabel_<?= $kbd['no_rg']; ?>" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="dokterlihatRekamMedisLabel_<?= $kbd['no_rg']; ?>">Lihat Rekam Medis Pasien</h5>
