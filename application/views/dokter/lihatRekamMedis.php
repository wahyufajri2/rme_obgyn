                    ...
                    <tbody>
                        ...
                        <?php foreach ($Kebidanan as $kbd) : ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#detailRekamMedis_<?= $kbd['no_rg']; ?>">
...
<!-- Modal Lihat Detail Rekam Medis -->
<?php foreach ($Kebidanan as $kbd) : ?>
    <div class="modal fade" id="#detailRekamMedis_<?= $kbd['no_rg']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="detailRekamMedisLabel_<?= $kbd['no_rg']; ?>" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detailRekamMedisLabel_<?= $kbd['no_rg']; ?>">Detail Rekam Medis Pasien</h5>
...
<?php endforeach; ?>
<!-- Akhir Modal Detail Rekam Medis -->
