    ...
    <div class="container-fluid px-3">
        ...
        <div class="card mb-4">
            <div class="card-body">
                        ...
                        <?php foreach ($menu as $m) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm"><i class=" fas fa-solid fa-trash-can fa-beat-fade" style="--fa-beat-fade-opacity: 0.67; --fa-beat-fade-scale: 1.075;"></i> Delete</button>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
                ...
                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#newMenuModal"><i class="fas fa-solid fa-circle-plus fa-beat-fade" style="--fa-beat-fade-opacity: 0.67; --fa-beat-fade-scale: 1.075;"></i> Tambah Menu Baru</a>
            </div>
        </div>
    </div>
</main>
