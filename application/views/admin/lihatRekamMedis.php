                    ...
                    <tbody>
                        ...
                        <?php foreach ($Kebidanan as $kbd) : ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#adminlihatRekamMedis_<?= $kbd['no_rg']; ?>">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="adminlihatRekamMedisLabel_<?= $kbd['no_rg']; ?>">Detail Rekam Medis Pasien</h5>
