                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($Kebidanan as $kbd) : ?>
                                        <tr>
                                            ...
                                            <td><?= $kbd['status']; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#EntriPasienAsesment"><i class="fas fa-solid fa-pen-to-square fa-beat-fade" style="--fa-beat-fade-opacity: 0.67; --fa-beat-fade-scale: 1.075;"></i> Catat</button>
                                                ...
                                                <a class="btn btn-outline-warning btn-sm" href="<?= base_url('bidan/printKebidanan'); ?>" target="_blank"><i class="fas fa-solid fa-print fa-beat-fade" style="--fa-beat-fade-opacity: 0.67; --fa-beat-fade-scale: 1.075;"></i> Cetak</a>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-gradient-secondary">
                <h5 class="modal-title text-white" id="EntriPasienAsesmentLabel">Catat rekam medis pasien</h5>
