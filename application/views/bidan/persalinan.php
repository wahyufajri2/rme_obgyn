                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($Persalinan as $psl) : ?>
                                        <tr>
                                            ...
                                            <td><?= $psl['status']; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#entriPasienPersalinan"><i class="fas fa-solid fa-pen-to-square fa-beat-fade" style="--fa-beat-fade-opacity: 0.67; --fa-beat-fade-scale: 1.075;"></i> Entry</button>
...
<!-- Modal Entri -->
<div class="modal fade" id="entriPasienPersalinan" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="entriPasienPersalinanLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-gradient-secondary">
                <h5 class="modal-title text-white" id="entriPasienPersalinanLabel">Entri Pasien Persalinan</h5>
