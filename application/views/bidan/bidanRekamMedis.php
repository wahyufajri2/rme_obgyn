                    ...
                    <tbody>
                        ...
                        <?php foreach ($Kebidanan as $kbd) : ?>
                            <tr>
                                ...
                                <td><?= $kbd['status']; ?></td>
                                <td>
                                    <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#catatRekamMedis">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#detailDataPasien">
...
<div class="modal fade" id="catatRekamMedis" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="catatRekamMedisLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="catatRekamMedisLabel">Catat Rekam Medis Pasien</h5>
